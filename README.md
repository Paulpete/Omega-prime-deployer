...
## What's New (2025-09-14)

- MCP Installer Preview: a lightweight `src/mcpInstaller.ts` that detects the best installation method (NPX/UVX/Docker) and includes a CloudMCP.run placeholder for one-click cloud-hosted MCP servers. See `docs/RELEASE_NOTES.md` and `docs/CLOUDMCP_INTEGRATION.md` for details.
